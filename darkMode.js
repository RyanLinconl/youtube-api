///DARK MODE ///
const btnLightModeToggle = document.getElementById('btn-light-mode-toggle');
const themeSystem = localStorage.getItem('themeSystem') || 'dark';

btnLightModeToggle.addEventListener('click', () => {
...
function defineCurrentTheme(theme){
    ...
    if(theme == "dark")
    {
        btnLightModeToggle.innerHTML = lightSvg
        return
    }
    btnLightModeToggle.innerHTML = darkSvg
}
